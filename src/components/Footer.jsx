        ...
        <footer className='bg-gray-900 text-gray-200 py-10'>
            <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
                ...
                <div className='mb-6 md:mb-0'>
                    ...
                    <p className='text-sm'>Email: support@E-Commerce.com</p>
                ...
                <div className='mb-6 md:mb-0'>
                    ...
                    <div className='flex space-x-4 mt-2 text-xl'>
                        ...
                        <a href="https://pinterest.com/yourpage" target="_blank" rel="noreferrer">
                            <FaPinterest className='hover:text-red-500 transition-colors cursor-pointer' />
                        </a>
                    </div>
                </div>
